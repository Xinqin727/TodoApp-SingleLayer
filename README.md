...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 6abbe733-b26e-426a-a328-85a92b062b4d
```

> `6abbe733-b26e-426a-a328-85a92b062b4d` is the password of the certificate, you can change it to any password you want.
